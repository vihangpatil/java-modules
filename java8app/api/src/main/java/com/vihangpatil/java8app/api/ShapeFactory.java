package com.vihangpatil.java8app.api;
...
public class ShapeFactory {
    ...
    public Optional<Shape> newInstance(final String shape, final Object... params) throws
        ...
        final Class<? extends Shape> shapeClass = (Class<? extends Shape>)
                Class.forName("com.vihangpatil.java8app.impl." + shape);
        final Constructor[] constructors = shapeClass.getConstructors();
        nextConstructor:
        for (Constructor<Shape> constructor : constructors) {
